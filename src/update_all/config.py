...
from update_all.constants import FILE_downloader_ini, K_BASE_PATH, K_BASE_SYSTEM_PATH, K_STORAGE_PRIORITY, K_DATABASES, \
    ...
    K_VERBOSE, \
    K_DB_URL, K_SECTION, K_CONFIG_PATH, K_USER_DEFINED_OPTIONS, KENV_INI_PATH, KENV_DOWNLOADER_LAUNCHER_PATH, \
...
from update_all.db_options import DbOptionsKind, DbOptions, DbOptionsValidationException
...
class ConfigReader:
    ...
    def calculate_config_path(self, current_working_dir):
        ini_path = self._env.get(KENV_INI_PATH, None)
